phylo.to.phylog<-function(tree){
    ...
    phylo.to.newick<-function(tree){
      ...
      return(string)
       ...
       #Obtained from: http://blog.phytools.org/2011/07/writing-phylo-object-to-newick-string.html

newick <- phylo.to.newick(tree)  
phylog <- ade4::newick2phylog(newick)
return(phylog)
}
